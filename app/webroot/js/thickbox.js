	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if(document.getElementById("TB_overlay") === null){
				...
				$("#TB_overlay").fadeIn("600").click(tb_remove);
			}
		}
...
function tb_remove() {
	...
	$("#TB_window").fadeOut("600",function(){$('#TB_window,#TB_overlay,#TB_HideSelect').trigger("unload").unbind().remove();});
	$("#TB_load").remove();
	if (typeof document.body.style.maxHeight == "undefined") {//if IE 6
