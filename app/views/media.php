 ...
 */
	function render() {
		...
		print_r($extension); print "<br>";
		print_r($this->mimeType[$extension]); print "<br>";
		die();
		//*/
		
		if (($content || file_exists($path)) && isset($extension) && isset($this->mimeType[$extension]) && connection_status() == 0) {
